...
<body class="bg-light text-light">
    <div id="content">
        <!-- Login UI -->
        <div class="container p-3 mt-4" id="login-interface">
            <div class="container-fluid p-2 my-4">
                <div class="row">
                        <div class="col-md-4 p-3">

                          </div>
                    <div class="col-md-4 p-4 shadow text-center rounded bg-dark">
                          <div class="m-2">
                                <img src="../memberships/branding/CFT/CFT emb.svg" width="140">
                        <h1 class="text-muted lead display-4 text-white">Login</h1>
                        <hr>
                        <div class="form-group">
                                <h5 class="lead mb-1">Email Address</h5>
                                <input type="email" ng-model="email" class="form-control" placeholder="Email address" required />
                        </div>
                        <div class="form-group">
                        ...
                        <hr>
                        <button ng-click="login()" class="btn btn-success" >Login</button>
                        <a href="register.php" class="btn btn-dark" >Register</a>

                        <span id="notification" class="mt-3">
                            </span>
                            <a href="../home" class="text-center text-muted my-1">Back to website</a>
                          </div>
                    </div>
