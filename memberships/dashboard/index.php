...
{
        echo '<div class="p-3 text-center text-white lead bg-danger shadow rounded">We currently offline till further notice</div>';
}
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light text-dark shadow">
...
<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          ...
          <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link text-muted" href="#/donation"><i class="fa fa-heart"></i> Donate</a>
              </li>
          <li class="nav-item">
        ...
        <ul class="navbar-nav">
                ...
                <li class="nav-item text-center " style="position: relative;right:0px!important;">
                        <a class="btn text-dark  shadow-sm  p-3 " href="#/signout" data-bind="click: user.signout"><i class="fa fa-sign-out"></i>  Logout </a>
                </li>
        </ul>
      </div>
 </nav>
    ...
    <script id="profile" type="text/x-kendo-template">
        <div class="container">
            <div class="display-4 text-muted">My Profile</div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <hr>
                        <input type="button" class="btn p-3 text-dark shadow-sm btn-lg" value="Update" data-bind="click: profile.Update" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <script id="welcome" type="text/x-kendo-template">
        <div class="container container-fluid p-2">
                    <form name="mystory" action="javascript:Member.updateStory(this.mystory);" method="POST" >
                              <h3 class="display-4 text-capitalize text-muted">Let's Hear Your Story</h3>  
                              <p class="mb-4 lead text-muted">Our communities are far behind with development and housing</p>
                              <div class="row p-2">
                              ...
                              <hr>
                              <button type="submit" class="btn p-3 text-dark shadow-sm btn-lg">Share Now</button>
                    </form>
        </div>
    </script>
    ...
    <div class="footer-copyright-area p-2 sticky-bottom shadow-sm mt-4 bg-light text-muted text-center">
        <div class="container">
            <div class="row">
